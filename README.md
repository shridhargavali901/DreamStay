...
- **Database**: MongoDB, Mongoose (Native Array Aggregation).

## 🚀 Architecture Focus
This project emphasizes clean code, secure API endpoints, and a component-driven frontend architecture, demonstrating production-ready development practices.

*Built from the ground up for performance and aesthetic perfection.*
